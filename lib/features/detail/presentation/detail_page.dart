    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            Text("patient_information".tr, style: WorkSansStyle.headline4),

            Padding(
              padding: const EdgeInsets.symmetric(vertical: 15),
              child: Column(
                children: [
                  PatientRowDetailInfo(label: "first_name".tr, value: "Akhmad"),
                  SizedBox(height: 10),
                  PatientRowDetailInfo(label: "last_name".tr, value: "Akhmad"),
                  SizedBox(height: 10),
